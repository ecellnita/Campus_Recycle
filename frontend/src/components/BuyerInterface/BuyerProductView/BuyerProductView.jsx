  ...
  const fetchAllProductrequests = async () => {
    ...
    try {
      ...
      const response = await apiConnector(
        "POST",
        authroutes.GET_ALL_SENT_PRODUCT_REQUESTS,
        bodyData,
        api_header
      );
        ...
        <div className="buyer-product-view-container-product-details">
          <div className="buyer-product-view-container-product-details-info">
            <div className="seller-account">
              ...
              <div className="profile-desc">
                <h6>
                  Selling from {product && product.owner.firstname}{" "}
            ...
            <div className="product-perks">
              ...
              <div className="perk-info">
                ...
                <p>
                  Help them to find what they need and support sustainable
                  choices.
                </p>
              </div>
            </div>
            <div className="product-perks">
              ...
              <div className="perk-info">
                ...
                <p>
                  let’s reduce waste together. Turn clutter into cash while
            ...
            <div className="what-will-you-do">
              ...
              <p>
                If you want a particular item, select the item and click on the
                "Request" button to add it to your list. After verification, we
                will confirm your order.
              </p>
              <p>
                The product will be delivered within 2-3 working days. Payment
                can be made either online or in person at the time of delivery.{" "}
              </p>
              <p>
                You can cancel your order anytime by removing your request from
                the "Orders" section.
              </p>
              <p>
                Make sure the product is in the same condition as described on
                the page.
              </p>
            </div>
          ...
          <div className="buyer-product-view-container-product-details-request">
            <div className="price-card">
              <h5>&#x20B9;{product && product.price} Per Product</h5>
              <p>
                {product && product.quantity} left - {product && product.status}
              </p>
              <div className="quantity-input">
                <span
                  className={`quantity-input-btn-plus ${
                    productQuantity + 1 > (product && product.quantity)
                      ? "disabled"
                      : ""
                  }`}
